...
extern void LCD_SetCursor(u8 Xpos, u16 Ypos);
...
extern void LCD_Color(u16 x,u8 y,u16 w,u8 h,u16 color);
extern void EllipsePlot(int x0,int y0,int x,int y);
extern void LCD_DrawEllipse(u8 xc,u8 yc,u8 a,u8 b);
extern void LCD_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2);
extern void LCD_DrawTriangle(u8 x0,u8 y0,u8 x1,u8 y1,u8 x2,u8 y2);
extern void LCD_DrawRectangle(u8 x1, u16 y1, u8 x2, u16 y2);
extern void LCD_DrawCircle(u8 x0,u16 y0,u8 r);
extern void LCD_DrawPoint_color(u16 x,u16 y);
#endif
